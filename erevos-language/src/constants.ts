...
export const MODULE_METHODS: Record<string, string[]> = {
  ...
  'builtin/network':  ['get','get_auth','post','post_auth','download','encode','http_get','http_get_auth','http_post','http_post_auth','http_download','hls_download_best','url_encode'],
  'builtin/net':      ['get','get_auth','post','post_auth','download','encode','http_get','http_get_auth','http_post','http_post_auth','http_download','hls_download_best','url_encode'],
  'builtin/websocket':['connect','send','recv','close','ws_connect','ws_send','ws_recv','ws_close'],
  'builtin/ws':       ['connect','send','recv','close','ws_connect','ws_send','ws_recv','ws_close'],
...
export const BUILT_INS: readonly string[] = [
  ...
  'http_get','http_get_auth','http_post','http_post_auth','http_download','hls_download_best','url_encode',
