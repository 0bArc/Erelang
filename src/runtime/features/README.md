...
This folder is the extension point for adding runtime language features without bloating `src/runtime/core.cpp`.

## Pattern

1. Add a focused header in `include/erelang/features/`.
2. Add implementation in `src/runtime/features/`.
...
- Add `src/runtime/features/my_feature.cpp`
